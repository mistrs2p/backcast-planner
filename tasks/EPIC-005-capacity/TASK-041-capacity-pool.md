...
## Objective
Implement the **Capacity pool** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-041-capacity-pool` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
