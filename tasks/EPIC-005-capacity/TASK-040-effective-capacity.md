...
## Objective
Implement the **Effective capacity** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-040-effective-capacity` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
