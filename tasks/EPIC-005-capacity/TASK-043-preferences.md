...
## Objective
Implement the **Preferences** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-043-preferences` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
