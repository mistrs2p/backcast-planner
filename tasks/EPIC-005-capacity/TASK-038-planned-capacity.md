...
## Objective
Implement the **Planned capacity** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-038-planned-capacity` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
