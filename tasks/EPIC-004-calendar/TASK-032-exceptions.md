...
## Objective
Implement the **Exceptions** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-032-exceptions` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
