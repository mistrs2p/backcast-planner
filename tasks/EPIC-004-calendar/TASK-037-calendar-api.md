...
## Objective
Implement the **Calendar API** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-037-calendar-api` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
