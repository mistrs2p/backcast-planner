...
## Objective
Implement the **Recurrence rules** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-031-recurrence-rules` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
