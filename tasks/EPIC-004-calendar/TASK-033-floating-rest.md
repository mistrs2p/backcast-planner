...
## Objective
Implement the **Floating rest** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-033-floating-rest` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
