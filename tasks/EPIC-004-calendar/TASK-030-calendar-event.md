...
## Objective
Implement the **Calendar event** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-030-calendar-event` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
