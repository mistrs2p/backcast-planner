...
## Objective
Implement the **Trend analysis** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-074-trend-analysis` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
