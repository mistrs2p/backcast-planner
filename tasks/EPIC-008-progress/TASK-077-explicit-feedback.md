...
## Objective
Implement the **Explicit feedback** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-077-explicit-feedback` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
