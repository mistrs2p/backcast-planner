...
## Objective
Implement the **Goal health** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-075-goal-health` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
