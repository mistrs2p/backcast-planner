...
## Objective
Implement the **Velocity** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-072-velocity` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
