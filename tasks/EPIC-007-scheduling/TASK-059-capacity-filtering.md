...
## Objective
Implement the **Capacity filtering** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-059-capacity-filtering` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
