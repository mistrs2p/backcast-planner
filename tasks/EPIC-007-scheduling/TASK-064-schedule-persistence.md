...
## Objective
Implement the **Schedule persistence** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-064-schedule-persistence` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
