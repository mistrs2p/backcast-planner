...
## Objective
Implement the **Preference scoring** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-062-preference-scoring` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
