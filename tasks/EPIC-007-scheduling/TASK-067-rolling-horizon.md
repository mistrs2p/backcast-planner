...
## Objective
Implement the **Rolling horizon** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-067-rolling-horizon` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
