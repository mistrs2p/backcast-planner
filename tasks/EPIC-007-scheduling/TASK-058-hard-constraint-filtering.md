...
## Objective
Implement the **Hard constraint filtering** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-058-hard-constraint-filtering` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
