...
## Objective
Implement the **Rescheduling** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-066-rescheduling` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
