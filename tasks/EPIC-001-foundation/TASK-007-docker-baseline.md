...
## Objective
Implement the **Docker baseline** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-007-docker-baseline` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
