...
## Objective
Implement the **AGENTS.md enforcement** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-002-agents-md-enforcement` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
