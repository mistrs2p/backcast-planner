...
## Objective
Implement the **CI baseline** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-006-ci-baseline` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
