...
## Objective
Implement the **Replanning policy** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-083-replanning-policy` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
