...
## Objective
Implement the **Plan comparison** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-088-plan-comparison` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
