...
## Objective
Implement the **Local replan** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-085-local-replan` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
