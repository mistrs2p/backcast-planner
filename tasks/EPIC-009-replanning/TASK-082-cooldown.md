...
## Objective
Implement the **Cooldown** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-082-cooldown` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
