...
## Objective
Implement the **Regional replan** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-086-regional-replan` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
