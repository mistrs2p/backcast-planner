...
## Objective
Implement the **Replanning decision engine** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-084-replanning-decision-engine` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
