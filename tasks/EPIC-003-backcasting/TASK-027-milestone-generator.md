...
## Objective
Implement the **Milestone generator** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-027-milestone-generator` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
