...
## Objective
Implement the **Backcasting run** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-022-backcasting-run` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
