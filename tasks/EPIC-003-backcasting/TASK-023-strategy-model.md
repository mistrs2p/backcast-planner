...
## Objective
Implement the **Strategy model** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-023-strategy-model` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
