...
## Objective
Implement the **Gap calculation** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-021-gap-calculation` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
