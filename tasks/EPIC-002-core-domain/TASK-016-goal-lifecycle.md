...
## Objective
Implement the **Goal lifecycle** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-016-goal-lifecycle` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
