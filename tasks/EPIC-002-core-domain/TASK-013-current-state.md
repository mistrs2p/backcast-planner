...
## Objective
Implement the **Current State** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-013-current-state` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
