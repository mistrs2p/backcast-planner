...
## Objective
Implement the **Task decomposition contract** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-054-task-decomposition-contract` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
