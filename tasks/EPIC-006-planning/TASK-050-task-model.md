...
## Objective
Implement the **Task model** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-050-task-model` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
