# TASK-102 — AI evaluation dataset
...
## Objective
Implement the **AI evaluation dataset** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-102-ai-evaluation-dataset` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
