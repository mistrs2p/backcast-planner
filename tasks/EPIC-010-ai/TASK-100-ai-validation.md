...
## Objective
Implement the **AI validation** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-100-ai-validation` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
