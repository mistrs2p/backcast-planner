...
## Objective
Implement the **AI fallback** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-103-ai-fallback` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
