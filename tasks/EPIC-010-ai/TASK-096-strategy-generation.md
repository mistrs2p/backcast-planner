...
## Objective
Implement the **Strategy generation** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-096-strategy-generation` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
