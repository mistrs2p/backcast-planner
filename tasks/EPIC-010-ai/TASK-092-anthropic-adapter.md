...
## Objective
Implement the **Anthropic adapter** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-092-anthropic-adapter` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
