# TASK-097 — Outcome decomposition
...
## Objective
Implement the **Outcome decomposition** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-097-outcome-decomposition` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
