...
## Objective
Implement the **LLM provider interface** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-090-llm-provider-interface` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
