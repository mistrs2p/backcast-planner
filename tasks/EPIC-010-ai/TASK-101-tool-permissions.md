...
## Objective
Implement the **Tool permissions** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-101-tool-permissions` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
