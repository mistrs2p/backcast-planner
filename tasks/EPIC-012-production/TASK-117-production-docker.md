...
## Objective
Implement the **Production Docker** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-117-production-docker` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
