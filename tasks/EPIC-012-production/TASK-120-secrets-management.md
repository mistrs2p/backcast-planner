...
## Objective
Implement the **Secrets management** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-120-secrets-management` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
