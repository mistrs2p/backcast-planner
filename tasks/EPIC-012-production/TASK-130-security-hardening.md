...
## Objective
Implement the **Security hardening** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-130-security-hardening` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
