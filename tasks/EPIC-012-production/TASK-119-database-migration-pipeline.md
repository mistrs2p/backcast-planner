# TASK-119 — Database migration pipeline
...
## Objective
Implement the **Database migration pipeline** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-119-database-migration-pipeline` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
