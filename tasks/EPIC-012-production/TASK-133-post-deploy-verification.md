# TASK-133 — Post-deploy verification
...
## Objective
Implement the **Post-deploy verification** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-133-post-deploy-verification` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
