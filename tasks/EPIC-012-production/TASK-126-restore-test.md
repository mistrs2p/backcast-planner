...
## Objective
Implement the **Restore test** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-126-restore-test` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
