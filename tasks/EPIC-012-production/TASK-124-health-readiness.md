...
## Objective
Implement the **Health/readiness** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-124-health-readiness` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
