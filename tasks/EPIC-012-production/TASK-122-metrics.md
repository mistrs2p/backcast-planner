...
## Objective
Implement the **Metrics** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-122-metrics` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
