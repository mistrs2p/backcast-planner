...
## Objective
Implement the **Incident workflow** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-131-incident-workflow` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
