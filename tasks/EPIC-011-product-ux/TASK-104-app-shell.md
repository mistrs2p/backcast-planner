...
## Objective
Implement the **App shell** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-104-app-shell` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
