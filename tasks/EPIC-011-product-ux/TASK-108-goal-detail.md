...
## Objective
Implement the **Goal detail** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-108-goal-detail` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
