...
## Objective
Implement the **Replanning UI** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-115-replanning-ui` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
