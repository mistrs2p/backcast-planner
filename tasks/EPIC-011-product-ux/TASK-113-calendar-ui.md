...
## Objective
Implement the **Calendar UI** capability as defined by the project specification.
...
## Git
Use branch `feature/TASK-113-calendar-ui` unless `fix/`, `chore/`, or `docs/` is more appropriate. Use an atomic Conventional Commit and push the branch after completion.
